...
<div class="auth-card">
    ...
    <div class="text-center mb-4">
        ...
        <p class="fs-sm text-muted mt-1">
            ...
            <span class="fw-semibold text-dark">{{ session('register_phone') }}</span>
        </p>
    </div>

    <form method="POST" action="{{ route('register.verify-otp') }}" class="vstack gap-3">
        @csrf
        <div>
    ...
    <div class="mt-3 text-center">
        <a href="{{ route('register') }}" class="fs-sm text-muted">
            ← Change number
        </a>
    </div>
