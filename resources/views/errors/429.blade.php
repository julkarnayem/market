...
<body class="min-vh-100 bg-light d-grid place-items-center p-4">
    <div class="text-center max-w-md">
        ...
        <p class="text-secondary font-mono fs-sm fw-medium mb-2">429</p>
        <h1 class="font-display fs-3 fw-bold text-dark mb-2">Too Many Requests</h1>
        <p class="text-muted mb-4">You've sent too many requests. Please wait a moment and try again.</p>
